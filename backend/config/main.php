    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'bejegyzesek/letrehozas' => 'post/create',
                'bejegyzesek/<id:\d+>' => 'post/view',
                'bejegyzesek/<id:\d+>/szerkesztes' => 'post/update',
                'bejegyzesek/<id:\d+>/torles' => 'post/delete',
                'bejegyzesek/tomeges-torles' => 'post/bulk-delete',
                'bejegyzesek/gyors-szerkesztes/<id:\d+>' => 'post/quick-edit',
                'bejegyzesek/allapot-valtas/<id:\d+>' => 'post/toggle-status',
                
                'mediatar' => 'media/index',
                'mediatar/feltoltes' => 'media/create',
                'mediatar/<id:\d+>' => 'media/view',
                'mediatar/<id:\d+>/szerkesztes' => 'media/update',
                'mediatar/<id:\d+>/torles' => 'media/delete',
                'mediatar/tomeges-torles' => 'media/bulk-delete',
                'mediatar/ajax-feltoltes' => 'media/ajax-upload',
                
                'rendszerlogok' => 'log/index',
                'rendszerlogok/statisztikak' => 'log/stats',
                'rendszerlogok/<id:\d+>' => 'log/view',
                'rendszerlogok/<id:\d+>/torles' => 'log/delete',
