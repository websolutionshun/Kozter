                ...
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <?= Html::a('
                            ...
                            Új szerepkör', ['create'], ['class' => 'btn btn-primary btn-sm']) ?>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <?php else: ?>
                                            <span class="btn btn-sm btn-outline-secondary disabled" title="Az alapértelmezett szerepköröket nem lehet törölni">
