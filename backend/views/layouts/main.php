                ...
                <div class="collapse navbar-collapse" id="sidebar-menu">
                    <ul class="navbar-nav pt-lg-2">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#navbar-users" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div class="navbar-nav flex-row order-md-last">
                        <div class="d-none d-md-flex">
                                            ...
                                            <div class="list-group-item">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-truncate">
                                                        ...
                                                        <div class="d-block text-secondary text-truncate mt-n1">Új funkciók elérhetők a rendszerben</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="list-group-item">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-truncate">
                                                        ...
                                                        <div class="d-block text-secondary text-truncate mt-n1">Új felhasználó regisztrált a rendszerbe</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="nav-item dropdown d-none d-md-flex me-3">
                                <a href="#" class="nav-link px-0" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show app menu" data-bs-auto-close="outside">
